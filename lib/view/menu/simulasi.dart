...
class _SimulasiState extends State<Simulasi> {
   ...
   List itemName =[ "Kredit Simulasi", "Simulasi IB Bima Emas", "Simulasi IB Rahn Emas"];
   List foto =[landing1, landing2, landing3];
         ...
         SizedBox(height: Dimension.height20,),
          Row(
            ...
            children: [
              ...
              BigText(text: "Simulasi"),
              Padding(
                padding:  EdgeInsets.symmetric(horizontal: Dimension.width15),
                child: const Icon(Symbols.notifications, color:AppColors.theme,),
              )
            ],
          ),
          Expanded(
